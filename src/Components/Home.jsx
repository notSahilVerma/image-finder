    ...
    <>
      ...
      >
        <div className="container-fluid d-flex flex-column justify-content-center">
          <div
            className="bgImage rounded d-flex flex-column justify-content-center mt-3 heroLoad"
            style={{ backgroundImage: `url('./images/bg4.jpg` }}>
            <div className="col-9 col-md-6 col-lg-4 mx-auto mt-4 heroLogo">
              <img
                className="w-50 img-fluid mx-auto d-block"
                src="./images/logo.png"
                alt="loading"
                style={{ filter: `blur("150px")` }}
              />
            </div>
            <div className=" color-overlay rounded mx-auto d-flex justify-content-center align-items-center w-100">
              <h1 className="h1 lead fs-1">IMAGE FINDER</h1>
            </div>
            <div
              className="container d-flex col-11 col-md-7 col-lg-5 my-5 flex-column flex-md-row"
              onKeyDown={(e) => {
                detectKeyDown(e);
              }}
            >
              ...
              />
              <button
                className="btn btn-outline-light fw-lighter mx-auto mt-4 mt-md-0 w-auto"
          ...
          <div className="row justify-content-center ">
            <div className="col-10 text-center">
              ...
              {image.length ? <hr /> : ""}
              {image.length ? (
                <div className="container col-1 lead">
                  <p>{page}</p>
                </div>
              ) : (
                ""
